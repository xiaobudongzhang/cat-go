...
func (e *BinaryEncoder) writeI64(buf *bytes.Buffer, i int64) (err error) {
	for {
		if i&^0x7F == 0 {
...
func (e *BinaryEncoder) writeString(buf *bytes.Buffer, s string) (err error) {
	if err = e.writeI64(buf, int64(len(s))); err != nil {
		return
	}
...
func (e *BinaryEncoder) encodeMessageStart(buf *bytes.Buffer, m Messager) (err error) {
	...
	if err = e.writeI64(buf, timestamp); err != nil {
		return
	}
...
func (e *BinaryEncoder) encodeMessageEnd(buf *bytes.Buffer, m Messager) (err error) {
	...
	if m.GetData() == nil {
		if err = e.writeI64(buf, 0); err != nil {
			return
		}
	} else {
		if err = e.writeI64(buf, int64(m.GetData().Len())); err != nil {
			return
		}
...
func (e *BinaryEncoder) EncodeTransaction(buf *bytes.Buffer, trans *Transaction) (err error) {
	...
	if err = e.writeI64(buf, duration); err != nil {
		return
	}
	return
}
